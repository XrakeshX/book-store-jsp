...
<body>
    <header>
        ...
        <div class="menu">
            <ul class="nav-bar">
                <li class="active"><a href="index_page.jsp">Home</a></li>
                <li><a href="./pages/book_page.jsp">Books</a></li>
                <%if(session.getAttribute("loggedin") == "true"){%>
                        <li><a>Welcome, <%=session.getAttribute("username")%></a></li>
                        <li><a href="./classes/logout">Logout</a></li>
                <%}else{%>
                    <li><a href="./pages/login_page.jsp">Login</a></li>    
                    <li><a href="./pages/register_page.jsp">Register</a></li>
                <%}%>    
            </ul>
        </div>

        <div class="search">
            <a href="./classes/authcart"><img src="img/cart.png" alt="" style="width: 40px; height: 40px;"></a>        
        </div>
        <div class="lines">
        </div>
    </header>
